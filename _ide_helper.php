 ...
 * Generated for Laravel 8.83.13 on 2022-05-20.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Mail {
        ...
        {
            return \Illuminate\Mail\MailManager::createTransport($config);
        }
        ...
        {
            return \Illuminate\Support\Testing\Fakes\MailFake::failures();
        }
    ...
    class Request {
        ...
        {
            \Illuminate\Http\Request::dd(...$keys);
        }
...
')
    ...
    class URL {
        ...
        {
            return \Illuminate\Routing\UrlGenerator::hasValidRelativeSignature($request);
        }
...
namespace Facade\Ignition\Facades { 
    ...
    class Flare {
        ...
        {
            return \Facade\FlareClient\Flare::determineVersionUsing($determineVersionCallable);
        }
        ...
        {
            return \Facade\FlareClient\Flare::reportErrorLevels($reportErrorLevels);
        }
        ...
        {
            return \Facade\FlareClient\Flare::filterExceptionsUsing($filterExceptionsCallable);
        }
        ...
        public static function version()
        {
            return \Facade\FlareClient\Flare::version();
        }
        ...
        {
            return \Facade\FlareClient\Flare::censorRequestBodyFields($fieldNames);
        }
...
namespace KodiCMS\Assets\Facades { 
    ...
    class PackageManager {
         ...
         *
         * @param \Illuminate\Support\array<callable> $pipes
         * @return mixed 
         * @static 
         */ 
        public static function pipeThrough($pipes)
        {
            //Method inherited from \Illuminate\Support\Collection            
            return \KodiCMS\Assets\PackageManager::pipeThrough($pipes);
        }
         ...
         * @static 
         */ 
        public static function reduceMany($callback, ...$initial)
        {
            //Method inherited from \Illuminate\Support\Collection            
            return \KodiCMS\Assets\PackageManager::reduceMany($callback, ...$initial);
        }
