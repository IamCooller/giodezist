 ...
 * Class Videos
 *
 * @property \App\Models\Videos $model
 *
...
class Videos extends Section 
{
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::image('VideosImg_oz', 'Изображение'),
            AdminColumn::text('published_oz', 'Дата')->setHtmlAttribute('class', 'text-center'),     
            AdminColumn::text('VideosTitle_oz', 'Заголовок'),
        ];
        ...
        $tabs->setTabs(function ($id) {
            ...
            $tab[] = AdminDisplay::tab(AdminForm::elements([
                ...
                ->addColumn([                               
                    ...
                    AdminFormElement::text('VideosTitle_ru', 'Название'),
             
                    AdminFormElement::html('<hr>'),
                ], 'col-xs-12 col-sm-6 col-md-6 col-lg-6')
                ->addColumn([
                 
                    AdminFormElement::image('VideosImg_ru', 'Изображение'),
                    AdminFormElement::date('published_ru', 'Дата')->setCurrentDate(),
                    
                    AdminFormElement::html('<hr>'),
                    
                ], 'col-xs-12 col-sm-6 col-md-6 col-lg-6'),
                AdminFormElement::text('VideosContent_ru', 'ID Youtube видео (вводить через ,)'),
            ]))->setLabel('RU');
                return $tab;
        });
        ...
        $tabs->setTabs(function ($id) {
            ...
            $tab[] = AdminDisplay::tab(AdminForm::elements([
                ...
                ->addColumn([                               
                    ...
                    AdminFormElement::text('VideosTitle_oz', 'Название'),
               
                    AdminFormElement::html('<hr>'),
                ], 'col-xs-12 col-sm-6 col-md-6 col-lg-6')
                ->addColumn([
                   
                    AdminFormElement::image('VideosImg_oz', 'Изображение'),
                    AdminFormElement::date('published_oz', 'Дата')->setCurrentDate(),
                    
                    AdminFormElement::html('<hr>'),
                    
                ], 'col-xs-12 col-sm-6 col-md-6 col-lg-6'),
                AdminFormElement::text('VideosContent_oz', 'ID Youtube видео (вводить через ,)'),
            ]))->setLabel('OZ');
            return $tab;
        });
        ...
        $tabs->setTabs(function ($id) {
            ...
            $tab[] = AdminDisplay::tab(AdminForm::elements([
                ...
                ->addColumn([                               
                    ...
                    AdminFormElement::text('VideosTitle_en', 'Название'),
            
                    AdminFormElement::html('<hr>'),
                ], 'col-xs-12 col-sm-6 col-md-6 col-lg-6')
                ->addColumn([
                    
                    AdminFormElement::image('VideosImg_en', 'Изображение'),
                    AdminFormElement::date('published_en', 'Дата')->setCurrentDate(),
                    
                    AdminFormElement::html('<hr>'),
                    
                ], 'col-xs-12 col-sm-6 col-md-6 col-lg-6'),
                AdminFormElement::text('VideosContent_en', 'ID Youtube видео (вводить через ,)'),
            ]))->setLabel('EN');
            return $tab;
        });
